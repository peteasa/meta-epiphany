...
# the exotic-gcc-cross-canadian_4.8.bb file and the following will be
...
## Moved these to autotools_exotic
# TARGET_LDFLAGS_GVARIABLE = export TARGET_LDFLAGS="-Wl,-O1 -Wl,--hash-style=gnu -Wl,--as-needed"
#TARGET_CFLAGS = 
#TARGET_CXXFLAGS = 
...
#
## TODO work out what STAGING_BINDIR_TOOLCHAIN is
