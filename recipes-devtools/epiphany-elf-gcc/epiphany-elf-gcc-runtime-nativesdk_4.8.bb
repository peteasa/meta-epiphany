...
do_install () {
	   ...
	   cp ${STAGING_DIR}/${MACHINE}/usr/lib/${EXOTIC_TARGET_SYS}/libstdc* ${D}${exec_prefix}/lib/${EXOTIC_TARGET_SYS}
	   cp ${STAGING_DIR}/${MACHINE}/usr/lib/${EXOTIC_TARGET_SYS}/libsupc* ${D}${exec_prefix}/lib/${EXOTIC_TARGET_SYS}
